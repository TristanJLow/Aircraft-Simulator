...
public class Business extends Passenger {
	...
	public Business(int bookingTime, int departureTime) throws PassengerException {
		// Creates a new passenger in Business class.
	...
	public Passenger upgrade() {
		// Creates a new passenger in First class, copies the current passenger and returns them as the new passenger.
	    Passenger upgradedPassenger = new First();
		upgradedPassenger.copyPassengerState(this);
		upgradedPassenger.passID = "F(U)" + this.passID;
