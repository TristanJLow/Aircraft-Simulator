...
public class A380 extends Aircraft {
	...
	public A380(String flightCode, int departureTime) throws AircraftException {
		// Creates a new A380 aircraft with the input flightCode and departureTime, using the preset class numbers defined above.
	...
	public A380(String flightCode, int departureTime, int first, int business, int premium, int economy) throws AircraftException {
		// Creates a new A380 aircraft with the input flightCode, departureTime and number of seats in each classes.
	    super(flightCode, departureTime, first,business,premium,economy); 
		this.type = "A380";
	}
}
